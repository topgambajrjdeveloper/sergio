...
from tareas.api.router import router_tareas
from comentar.api.router import router_comentar

schema_view = get_schema_view(
    openapi.Info(
        title="GooglApp API",
        default_version='v1',
        description="ApiRest Django con Python para la aplicación GooglApp | Sergio Ferrer",
